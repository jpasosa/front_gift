							...
							<div class="bottom">
								...
								<form method="post"   action=""  enctype="multipart/form-data">
									...
									<div class="form-row">
										...
										<?php else: ?>
											<div class="form-row">
												<a href="<?php echo $preferenceResult["response"]["init_point"]; ?>" id="button_pay" name="MP-Checkout" class="orange-ar-m-sq-arall">Pay</a>
												<script type="text/javascript" src="http://mp-tools.mlstatic.com/buttons/render.js"></script>
											</div>
											<script> document.getElementById('button_pay').click(); </script>
										<?php endif; ?>
								</form>
							</div>
						</div>
...
<div id="wrapper">
  ...
  <div class="container">
    <div class="row">
      <div style="margin-bottom:30px;">
        <h1 style="text-align:center;">Regalá un Gift Certificate</h1>
        <p style="text-align:center; color:#555;"> Los datos que escribas los vas a ver en este Gift Certificate, que luego vas a recibir por mail para reenviarlo a quien corresponda. </p>
        <hr style="color:#999;" />
      </div>
    </div>
    <div class="row">
          ...
          <div class="form-box">
            <div class="bottom">
              ...
              <form method="post"   action=""  enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <textarea name="MensajePersonalizado" id="mensaje" required  disabled title="campo obligatorio" maxlength="150" placeholder="Mensaje personalizado (Hasta 150 caracteres)"><?php if (isset($gift['MensajePersonalizado'])): echo $gift['MensajePersonalizado'];endif; ?>
</textarea>
                </div>
                ...
                <?php else: ?>
                <div class="form-row"> <a href="<?php echo $preferenceResult["response"]["init_point"]; ?>" name="MP-Checkout" style="border: solid 1px #59060b;
color: #fff;
        ...
        <div class="form-box">
          <div class="bottom">
            <p> <strong>Aclaraciones:</strong> <br />
              - Si no recibis instantáneamente el Gift Certificate en tu casilla de mail, por favor verificá el Correo No Deseado.<br />
              - Validez del Voucher: 90 días a partir de la fecha de compra. </p>
          </div>
        </div>
        <div class="shadow"></div>
        <div class="clearfix"></div>
    ...
    <div class="row">
      <div class="footer">
        ...
        <ul>
          ...
          <li><strong>Email:</strong> <a class="link_sociales" href="mailto:info@spabelgrano.com"> info@spabelgrano.com</a></li>
          <li><strong>Dirección:</strong> Virrey del Pino 2237, Belgrano</li>
          <li> <a class="link_sociales" href="https://twitter.com/SpaBelgrano" target="_blank"> <img src="<?php echo base_url() . TEMPLATE_ASSETS; ?>images/twitter.png" width="20" height="20"> @spabelgrano </a> </li>
          <li> <a class="link_sociales" href="https://www.facebook.com/spabelgrano?fref=ts" target="_blank"> <img src="<?php echo base_url() . TEMPLATE_ASSETS; ?>images/facebook.png" width="20" height="20"> /spabelgrano </a> </li>
        </ul>
      </div>
    </div>
    <!-- FOOTER -->
